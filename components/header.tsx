      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
        ...
        <div className="hidden md:block">
          <Button asChild className="bg-primary hover:bg-primary/90">
            <SmartLink
              href="https://wa.me/254700569709?text=Hello%20Agitech%20Seedlings!%20I%20would%20like%20to%20inquire%20about%20your%20seedlings."
        ...
        <div className="md:hidden border-t bg-card">
          <div className="space-y-1 px-4 py-4">
            ...
            <SmartLink
              href="https://wa.me/254700569709?text=Hello%20Agitech%20Seedlings!%20I%20would%20like%20to%20inquire%20about%20your%20seedlings."
              loadingMessage="📱 Connecting you to WhatsApp..."
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-3 text-base font-medium text-primary-foreground"
            >
